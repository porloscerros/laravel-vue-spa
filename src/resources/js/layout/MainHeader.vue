<template>
    <nav id="header" class="bg-gray-900 fixed w-full z-10 top-0 shadow">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
                    ...
                    <div class="relative text-sm text-gray-100">
                        ...
                        <div id="userMenu" class="bg-gray-900 rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 invisible">
                            <ul class="list-reset">
                                ...
                                <li>
                                    <a @click="logout" href="#" class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">
                                    Logout
                                    </a>
                                </li>
                            </ul>
            ...
            <div v-if="user" class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-900 z-20" id="nav-content">
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">

                    <li v-for="link in links" class="mr-6 my-2 md:my-0">
                        <nav-bar-link :link="link"></nav-bar-link>
                    </li>
